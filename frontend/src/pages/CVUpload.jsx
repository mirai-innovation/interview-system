  ...
  return (
    <div className="min-h-screen bg-mesh-gradient">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-8 max-w-7xl">
        ...
        {/* Analyzing Indicator */}
        {analyzing && (
          <div className="glass-card bg-blue-50/80 border-blue-200 p-4 sm:p-6 mb-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-blue-800 font-semibold">Analyzing your CV...</p>
              <p className="text-blue-700 text-sm">Extracting your skills and generating personalized interview questions. This may take a moment.</p>
            </div>
          </div>
        )}
